...
// Profile editing fields (avatar, name, telegram chat id, new password).
// Reused inside the "Perfil" tab of the Settings dialog.
    ...
    <div className="space-y-5 pt-1">
      ...
      <div className="space-y-1.5">
        ...
        <div className="flex gap-2">
          ...
          />
          <Button size="sm" onClick={handleSaveName} disabled={loading} className="h-8 text-xs px-3">
            Salvar
          </Button>
        </div>
      </div>
      ...
      <div className="space-y-1.5">
        ...
        <p className="text-[10px] text-muted-foreground">
          Envie /start para @Slvanessa_bot e use o chat ID recebido. Depois clique em Salvar.
        </p>
      </div>
