-- Black List: páginas que não devem aparecer nas buscas nem serem medidas.
ALTER TABLE public.spy_pages
  ADD COLUMN IF NOT EXISTS is_blacklisted boolean NOT NULL DEFAULT false,
  ADD COLUMN IF NOT EXISTS blacklisted_at timestamptz;

-- RPC de "Todos os resultados" atualizada para EXCLUIR páginas na blacklist.
